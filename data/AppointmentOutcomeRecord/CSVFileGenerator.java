...
package data.AppointmentOutcomeRecord;
import java.io.*;
import java.util.*;
import java.time.*;
...
public class CSVFileGenerator {
    ...
    private static void generateAppOutRecCSV(String patientID, List<String[]> treatRecData, DateTimeFormatter dateFormatter) {
