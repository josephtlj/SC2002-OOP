...
public class DoctorAppointmentController 
{
    ...
    //CHECK IF APPOINTMENT IS IN LIST OF SIEVED (PENDING OR CONFIRMED ETC) APPOINTMENTS
    ...
    public boolean updateAppointmentStatus(String status, LocalDate date, AppointmentTimeSlot timeSlot, String patientID)
    {
