...
public class AdministratorMenu {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 2:
                    System.out.print("Enter status (e.g., 'Pending', 'Confirmed'): ");
                    String status = scanner.nextLine();
                    displayAppointmentsByStatus(status);
                    break;
                case 4:
                    viewInventory();
                    break;
                case 5:
                    ...
                    int medicineAlert = scanner.nextInt();
                    scanner.nextLine();  // Consume newline
                    addInventoryItem(medicineName, medicineQuantity, medicineAlert);
                    break;
                case 6:
                    System.out.print("Enter medicine ID to update: ");
                    String updateMedicineId = scanner.nextLine();
                    ...
                    int newQuantity = scanner.nextInt();
                    scanner.nextLine();  // Consume newline
                    updateInventoryItem(updateMedicineId, newQuantity);
                    break;
                case 7:
                    System.out.print("Enter medicine ID to remove: ");
                    String removeMedicineId = scanner.nextLine();
                    removeInventoryItem(removeMedicineId);
                    break;
                case 8:
                    viewAlertLevelInventory();
                    break;
                case 9:
                    System.out.print("Enter replenishment request ID to approve: ");
                    UUID approveRequestId = UUID.fromString(scanner.nextLine());
                ...
                case 12:
                    ...
                    System.out.print("Enter department to filter by (or leave blank): ");
                    String department = scanner.nextLine();
                    filterStaff(role, gender, age, department);
                    break;
                case 13:
                    System.out.println("Exiting...");
                    return;
    ...
    // Methods from AdministratorController moved here
    ...
    public void getAllStaff() {
        staffManager.getAllStaff().forEach(System.out::println);
    }

    public void filterStaff(String role, String gender, Integer age, String department) {
        staffManager.filterStaff(role, gender, age, department).forEach(System.out::println);
    }
}
